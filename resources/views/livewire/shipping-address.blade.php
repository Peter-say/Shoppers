        ...
        <div class="p-3 p-lg-5 border">
            <div class="default-form">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$shopping_address->country}}" id="c_country" wire:model="country" placeholder="Enter a country">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" disabled id="c_fname" value="{{ $user->first_name }}">
                    </div>
                    <div class="col-md-6">
                        <label for="c_lname" class="text-black">Last Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" disabled id="c_lname" value="{{ $user->last_name }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" value="{{$shopping_address->address}}" id="c_address" wire:model="address"
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{$shopping_address->state}}" id="c_state_country" wire:model="state">
                        @error('state') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-6">
                        <label for="c_postal_zip" class="text-black">Postal / Zip <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" value="{{$shopping_address->zip_code}}" id="zip_code" wire:model="zip_code">
                ...
                <div class="form-group row mb-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{$shopping_address->phone_no}}" id="c_phone" wire:model="phone_no"
            ...
            <div class="form-group">
                ...
                <textarea wire:model="order_notes" id="c_order_notes" cols="30" rows="5" class="form-control"
                    placeholder="Write your notes here..."></textarea>
            </div>
            <div class="form-group d-flex justify-content-center">
                <button  wire:click.prevent="saveAddress" class="btn btn-primary btn-md w-100">Save address</button>
            </div>
