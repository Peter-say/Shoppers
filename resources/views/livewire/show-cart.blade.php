                                ...
                                @foreach ($cartItems as $item => $cartItem)
                                    <tr>
                                        <td class="product-thumbnail">
                                            <img src="{{ $cartItem->product->image }}" alt="Image" class="img-fluid">
                                        </td>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <a href="{{route('web.shop.index')}}" class="btn btn-outline-primary btn-sm btn-block">Continue Shopping</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
