...
@section('contents')
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="{{route('web.shop.index')}}">Home</a> <span class="mx-2 mb-0">/</span> <strong
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p><strong class="text-primary h4">${{$product->price_per_unit}}</strong></p>
                    ...
                    <div class="item">
                        <div class="block-4 text-center">
                            ...
                            <div class="block-4-text p-4">
                                ...
                                <p class="text-primary font-weight-bold">${{$category->price_per_unit}}</p>
                            </div>
                        </div>
                    </div>
