    ...
    <div class="main-content">
        <div class="section__content section__content--p30">
            ...
            <div class="container-fluid au-card mb-2">
                <form action="{{ route('admin.dashboard.product.store') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="basic_unit" name="basic_unit" type="text"
                                    ...
                                    value="{{ old('basic_unit') }}" value="{{ old('basic_unit') }}">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="cc-payment" name="discount_price" type="text"
                                    ...
                                    value="{{ old('discount_price') }}" placeholder="Enter Price">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="editor"  class="form-control" cols="10" rows="5" >{{ old('description') }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
