        ...
        <div class="container">
                                ...
                                <table class="table site-block-order-table mb-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-black font-weight-bold"><strong>${{ $totalPrice }}</strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <form action="{{ route('user.dashboard.place-order') }}" method="post">
                                    ...
                                    <div class="m-2">
                                        ...
                                        <div class="d-flex flex-row">
                                            <div class="d-flex align-items-center pe-2">
                                                <input class="radio-check-input" id="paypal-check-input" type="radio"
                                                    name="payment_method" value="paypal" id="radioNoLabel2" value=""
                                                    aria-label="..." />
                                            </div>
                                            <div class="rounded border d-flex w-100 p-3 align-items-center">
                                                ...
                                                <div class="ms-auto"><svg xmlns="http://www.w3.org/2000/svg" height="2em"
                                                    ...
                                                    </svg><span class="m-2 "><b>Pay With Flutterwave</b></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="pay-with-paypal-button">
                                        <button onclick="initiatePayment()"
                                            class="btn btn-primary btn-lg py-3 btn-block">Continue with Flutterwave
                                        </button>
                                    </div>
            ...
            <script>
                function initiatePayment() {
                    window.location.href = "{{ route('user.dashboard.flutterwave.payment.initiate') }}";
                }
            </script>
